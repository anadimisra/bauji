...
class JobPostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create job_post" do
    assert_difference('JobPost.count') do
      post job_posts_url, params: { job_post: { active: @job_post.active, description: @job_post.description, experience: @job_post.experience, location: @job_post.location, name: @job_post.name, skills: @job_post.skills } }
    end
  ...
  test "should update job_post" do
    patch job_post_url(@job_post), params: { job_post: { active: @job_post.active, description: @job_post.description, experience: @job_post.experience, location: @job_post.location, name: @job_post.name, skills: @job_post.skills } }
