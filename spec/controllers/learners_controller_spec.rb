...
RSpec.describe LearnersController, type: :controller do
  ...
  # Learner. As you add validations to Learner, be sure to
  ...
  # LearnersController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "redirects to the created learner" do
        post :create, params: {learner: valid_attributes}, session: valid_session
        expect(response).to redirect_to(Learner.last)
      end
    end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested learner" do
      learner = Learner.create! valid_attributes
      expect {
        delete :destroy, params: {id: learner.to_param}, session: valid_session
      }.to change(Learner, :count).by(-1)
    end

    it "redirects to the learners list" do
      learner = Learner.create! valid_attributes
      delete :destroy, params: {id: learner.to_param}, session: valid_session
      expect(response).to redirect_to(learners_url)
    end
  end
